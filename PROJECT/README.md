...
**CivicPulse** is an individual Software Engineering project designed to improve the way citizens report civic problems and how municipal authorities receive, manage, and resolve those complaints.
